...
def _do_ml_retrain_background():
    """ML 재학습 백그라운드 실행 — MyBidFeedbackService._run_retrain 위임.

    기존 중복 구현 제거: lock·SQL·yega 피처를 _run_retrain과 공유.
    """
    from ...services import MyBidFeedbackService
    MyBidFeedbackService._run_retrain()
...
def trigger_inpo21c_bid_notices(
    ...
    """inpo21c 입찰공고 사전정보 수집 + bids 동기화 (동기 실행 — Render 슬립 방지).
