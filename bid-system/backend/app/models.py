...
class Bid(Base):
    ...
    construction_work_div = Column(String(200))   # 공사분류 (cnstrtnWorkDivNm)
    joint_supply_bid    = Column(String(10))       # 공동수급협정입찰여부 (Y/N)
    participant_limit   = Column(String(10))       # 참가제한여부 (Y/N)
