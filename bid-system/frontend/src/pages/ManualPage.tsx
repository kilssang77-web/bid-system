...
import { MANUAL_SECTIONS, type ManualSection } from './ManualData'
        ...
        if (s.type === 'img') return (
          <div key={i} className="my-5">
            <div className="rounded-xl border border-slate-200 overflow-hidden shadow-md bg-white">
              ...
              />
              {s.alt && (
                <div className="px-4 py-2 bg-slate-50 border-t border-slate-200 text-[12px] text-slate-500 text-center">
                  {s.alt}
                </div>
              )}
            </div>
      ...
      <header className="flex items-center gap-4 px-5 h-14 border-b border-slate-200 bg-white shrink-0 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-blue-600 leading-none mt-0.5">사용자 매뉴얼 v4.0</p>
          </div>
        </div>
        ...
        <div className="ml-auto flex items-center gap-2">
          <span className="text-xs text-slate-400">2026-07-12</span>
          {isPopup && (
            <button
          ...
          <div className="max-w-4xl mx-auto px-8 py-8">
            ...
            <div className="mb-10 p-8 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl text-white text-center shadow-xl">
              ...
              <div className="mt-4 inline-block px-5 py-2 bg-white/20 rounded-full text-sm font-medium">
                사용자 매뉴얼 v4.0 · 2026-07-12
              </div>
              <p className="text-blue-200 text-sm mt-3">27장 구성 · 부록 3개 · 클라우드 호스팅 현행화</p>
            </div>
            ...
            <div className="mt-16 pt-8 border-t border-slate-200 text-center text-xs text-slate-400">
              BidAI Pro 사용자 매뉴얼 v4.0 · 2026-07-12 · © A2M
            </div>
          </div>
        </div>
      </div>
